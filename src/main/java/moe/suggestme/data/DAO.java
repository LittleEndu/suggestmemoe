...
public interface DAO extends Closeable {
    ...
    @SqlUpdate("CREATE OR REPLACE VIEW  v_animes AS SELECT id, name, score, last_updated, last_recommended FROM animes")
    ...
    @SqlUpdate("CREATE OR REPLACE VIEW  v_genres AS SELECT anime_id, genre_id FROM genres")
    ...
    @SqlUpdate("CREATE OR REPLACE VIEW  v_recommendations AS SELECT id1, id2 FROM recommendations")
    ...
    @SqlUpdate("CREATE OR REPLACE VIEW  v_users AS SELECT id, name FROM users")
